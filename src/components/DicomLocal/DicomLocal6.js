...
export default function DicomLocal6({ selectedCase, selectedStudy }) {
  useEffect(() => {
    if (typeof window !== "undefined") {
      // Dynamically load necessary scripts
      const loadScripts = async () => {
        const scriptsToLoad = [
          "https://unpkg.com/cornerstone-core@2.3.0/dist/cornerstone.min.js",
          "https://unpkg.com/dicom-parser/dist/dicomParser.min.js",
  ...
  function loadDcmFile() {
    ...
    reader.onload = function (e) {
      ...
      cornerstone.displayImage(
        document.getElementById("seriesContainers"),
        image
      );
    };
